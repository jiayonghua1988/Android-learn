package com.example.common_base.widget.gridviewpager;
...
import com.example.common_base.widget.IndicatorView;
...
public class GridViewPager extends RelativeLayout {
    ...
    private void init() {
        ...
        viewPager = (ViewPager) view.findViewById(R.id.vp_grid_viewpager);
        indicatorView = (IndicatorView) view.findViewById(R.id.iv_grid_indicator);
    }
